...
// import 'package:drive_car/views/AuthScreens/otp_screen.dart';
// import 'package:drive_car/views/AuthScreens/signup_screeen.dart';
// import 'package:drive_car/views/ForgotPassword/forgot_password..dart';
...
//   static const Color _secondaryColor = Color(0xFF26A69A); // Darker Teal
...
//   Widget _buildLoginForm(double screenHeight, double screenWidth, bool isTablet) {
//     return Container(
...
//   // Place this right after the password field (before the SizedBox(height: 20) that precedes the login button)
...
//                 const ForgotMobileScreen(), // replace with your screen
//             transitionsBuilder:
...
//       // Updated to pass both mobile and password to the API
...
//           // You can replace OtpScreen with your main screen
//           Navigator.pushReplacement(
//             context,
//             PageRouteBuilder(
//               pageBuilder: (context, animation, secondaryAnimation) =>
//                   MainNavigationScreen(), // Replace with your main screen
...
//         } else {
//           HapticFeedback.heavyImpact();
//           _showErrorSnackBar("Invalid mobile number or password. Please try again.");
//         }
//       }
//     } catch (e) {
//       if (mounted) {
...
//   try {
//     // Get the AuthProvider from the widget tree instead of creating a new instance
//     final authProvider = Provider.of<AuthProvider>(context, listen: false);
    
//     // Set guest mode in provider
